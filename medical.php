...
<li><a href="ambulance.php">Ambulance details</a></li>
...
<div style=" height:auto">
  ...
  <table cellpadding="0" cellspacing="0" width="800px" height="100px" style="margin:auto; border:0px" class="tableborder">
        ...
        <tr><td >&nbsp;</td></tr> 
            ...
            <?php
$cn=makeconnection();
$s="select * from doctorinfo";

	$resultdoctor=mysqli_query($cn,$s);
	$r=mysqli_num_rows($resultdoctor);
	//echo $r;
	$n=0;
	while($data=mysqli_fetch_array($resultdoctor))
	{
?>
  <tr><td  >
           ...
           <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td><span class="title">Doctor Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><?php echo $data[0]; ?></td><td align="left" width="50%"></td></tr>
                 <tr><td><span class="title">Gender</span></td><td><?php echo $data[1]; ?></td></tr>
                  <tr><td style="width:24px"><span class="title">Degree</span></td><td><?php echo $data[2]; ?></td></tr>
                  <tr><td><span class="title">Email</span></td><td><?php echo $data[3]; ?></td></tr>
