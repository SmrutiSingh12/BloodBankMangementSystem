...
<tr><td class="lefttd">Donor Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{4,50}" title="please enter only character  between 4 to 50 for donor name" /></td></tr>
...
<tr><td class="lefttd">Age</td><td><input type="number" name="t2" required="required" pattern="[0-9]{2,2}" title="please enter only  numbers between 18 to 110 for age" /></td></tr>
